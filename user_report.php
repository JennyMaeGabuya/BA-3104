...
<header class="site-header">
  ...
  <main class="report-page" id="reportPage">
    ...
    <form id="foundForm" class="form-card" action="test_submit.php" method="POST" enctype="multipart/form-data" novalidate data-report-type="lost">
      ...
      <section class="form-section">
        ...
        <label class="field">
          ...
          <div class="hint">Provide detailed description to help identify their item.</div>
        </label>
        ...
        <label class="field upload-field" id="uploadField">
          ...
          <div class="dropzone" id="dropzone" tabindex="0" role="button" aria-label="Upload photo">
            ...
            <input type="file" id="fileInput" name="photo" accept="image/png, image/jpeg" aria-hidden="true">
          </div>
      ...
      <section class="form-section two-col">
        <div class="col">
          <label class="field">
            <span class="label-text">Last Seen Location & Time <span class="required">*</span></span>
            <select name="locationFound" id="locationFound" required>
              <option value="" disabled selected>Where was it last seen</option>
     ...
     <div class="info-box info-warning" role="note">
          <strong>Note:</strong> Reports with photos require admin approval before being posted publicly. This helps ensure quality and prevent misuse.
        </div>
      </section>
      ...
      <section class="form-section">
        ...
        <div class="info-box info-blue" role="note">
          <strong>Privacy Note:</strong> You will receive updates about your lost item via email and SMS. Please ensure your contact information is correct.
        </div>
      </section>
    ...
    <div class="info-card">
        <h3><span class="pin">📍</span> What happens next?</h3>
        <ol>
    ...
    <aside class="success-box" id="successBox" hidden>
      <div class="success-inner">
        ...
        <div class="success-text">
          ...
          <p>By reporting lost items, you're helping your fellow students, faculty, and staff recover their belongings. Your report will be verified and matched with found item reports. The rightful owner will be notified once verified.</p>
        </div>
      </div>
    </aside>
  </main>
