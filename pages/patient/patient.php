                        ...
                        <div class="table-wrapper">
                            <table class="appointment-table">
                                ...
                                <tbody id="pendingTable">
                                    <tr>
                                        <td colspan="9" class="empty-state">No pending appointments</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                        ...
                        <div class="table-wrapper">
                            <table class="appointment-table">
                                ...
                                <tbody id="approvedTable">
                                    <tr>
                                        <td colspan="9" class="empty-state">No approved appointments</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                        ...
                        <div class="table-wrapper">
                            <table class="appointment-table">
                                ...
                                <tbody id="bookedTable">
                                    <tr>
                                        <td colspan="10" class="empty-state">No booked appointments yet</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
